...
class OdomLocNode(Node):
	...
	def odom_callback(self,msg):
		...
		self.anguler_vel_z = msg.twist.twist.angular.z
...
def main():
	FILEPATH = "/home/luismr/ros2_ws/src/unmanned_systems_ros2_pkg/unmanned_systems_ros2_pkg/log/"
	...
	while rclpy.ok():
		...
		myData = [now, odom_node.current_position[0], odom_node.current_position[1],
			odom_node.orientation_euler[2], odom_node.linear_vel_x, odom_node.anguler_vel_z]
